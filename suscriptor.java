  ...
  String thread_topic;
    ...
    public void run(){
        try{
          ...
          FormaterServiceService myservice= new FormaterServiceService();
          FormaterService port=myservice.getFormaterServicePort();
...
public class suscriptor{
    ...
    //The action, the topic and the ServerSocket of the thread are sent. Then, the result is read
      ...
      else System.out.println("SUBSCRIBE OK");
    }
      catch(Exception e){
  		System.out.print("NETWORK ERROR\n");
  	}
