...
public class ObjectFactory {
    ...
    private final static QName _Format_QNAME = new QName("http://formater/", "format");
    private final static QName _FormatResponse_QNAME = new QName("http://formater/", "formatResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://formater/", name = "format")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://formater/", name = "formatResponse")
